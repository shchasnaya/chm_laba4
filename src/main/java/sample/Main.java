...
public class Main extends Application implements EventHandler<ActionEvent> {
    ...
    public void handle(ActionEvent event) {
        ...
        if (event.getSource() == graph) {
            ...
            Graph.show(function, Integer.parseInt(n.getText()) ,Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()), Integer.parseInt(x_Koshi.getText()), Double.parseDouble(y_Koshi.getText()));
        }
    }
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        methods.getItems().addAll("Eyler's method", "Runge-Kutta`s method", "Adams' method");
        methods.setValue("Eyler's method");

        VBox uppanel = new VBox();
        HBox hBox = new HBox(5);
        hBox.getChildren().addAll(methods, n, limitA, limitB,x_Koshi, y_Koshi);
    ...
    public void getMethod(ChoiceBox<String> methods) {
        ...
        if (method == "Eyler's method") {
            String function = enter.getText();
            out.setText(" ");
            out.setText(Eyler.eyler(function, Integer.parseInt(n.getText()) ,Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()), Integer.parseInt(x_Koshi.getText()), Double.parseDouble(y_Koshi.getText()) ));
            //Graph.show(function, Integer.parseInt(n.getText()) ,Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()), Integer.parseInt(x_Koshi.getText()), Double.parseDouble(y_Koshi.getText()));
        }
        if (method == "Runge-Kutta`s method") {
            String function = enter.getText();
            out.setText(" ");
            out.setText(Runge_Kutta.Runge_Kutta(function, Integer.parseInt(n.getText()) ,Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()), Integer.parseInt(x_Koshi.getText()), Double.parseDouble(y_Koshi.getText())));
            //Graph.show(function, Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()));
        }
        if (method == "Adams' method") {
            String function = enter.getText();
            out.setText(" ");
            out.setText(Adams.adams(function, Integer.parseInt(n.getText()) ,Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()), Integer.parseInt(x_Koshi.getText()), Double.parseDouble(y_Koshi.getText())));
            //Graph.show(function, Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()));
        }
